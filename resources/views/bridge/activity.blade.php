                ...
                <div class="section bg-color bg-opacity-10 my-0 pt-6 pb-4">
                    <div class="container">
                        ...
                        <div class="row gx-5 col-mb-80">
                            ...
                            <main class="postcontent col-lg-9 pb-0 pb-md-auto">
                                <div class="single-post mb-0">
                                    ...
                                    <div class="entry">
                                        ...
                                        <div class="entry-image">
                                            <a href="#"><img src="images/img1.jpg" alt="Blog Single"></a>
                                        </div>
                                        ...
                                        <div class="entry-content mt-4">
                                            ...
                                            <p>Nullam id dolor id nibh ultricies vehicula ut id elit. <a
                                                    href="#">Curabitur blandit tempus porttitor</a>. Integer posuere
                                            ...
                                            <blockquote>
                                                <p>Vestibulum id ligula porta felis euismod semper. Sed posuere
                                            ...
                                            <div class="masonry-thumbs grid-container row row-cols-4 mb-4" data-big="4"
                                                data-lightbox="gallery">
                                                <a class="grid-item" href="images/img1.jpg"
                                                    data-lightbox="gallery-item"><img src="images/img1.jpg"
                                                        alt="Gallery Thumb 1"></a>
                                                <a class="grid-item" href="images/img2.jpg"
                                                    data-lightbox="gallery-item"><img src="images/img2.jpg"
                                                        alt="Gallery Thumb 2"></a>
                                                <a class="grid-item" href="images/img3.jpg"
                                                    data-lightbox="gallery-item"><img src="images/img3.jpg"
                                                        alt="Gallery Thumb 3"></a>
                                                <a class="grid-item" href="images/img4.jpg"
                                                    data-lightbox="gallery-item"><img src="images/img4.jpg"
                                            ...
                                            <p>Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Aenean
                                                ...
                                                facilisis in, egestas eget quam. <a href="#">Nullam quis risus eget
                                                    urna</a> mollis ornare vel eu leo. Integer posuere erat a ante
                                            ...
                                            <div id="cnvs-article-share" class="card border-default my-4"
                                                data-onepage-settings="{&quot;offset&quot;:60,&quot;speed&quot;:1250,&quot;easing&quot;:false}">
                                    ...
                                    <div class="row text-center text-md-start justify-content-between my-5 mb-md-6">
                                        <div class="col-md-auto col-6">
                                            <a href="#"
                                                class="d-inline-flex align-items-center text-dark h-text-color"><i
                                                    class="uil uil-angle-left-b fs-3 me-1"></i><span>15 Ways to create
                                                    Healthy Habits</span></a>
                                        </div>
                                        <div class="col-md-auto col-6">
                                            <a href="#"
                                                class="d-inline-flex align-items-center text-dark h-text-color"><span>The
                                                    Next big thing is AI</span><i
                            ...
                            <aside class="sidebar col-lg-3 mb-5 mb-md-0">
                                <div class="sidebar-widgets-wrap">
                                    <div class="widget">
                                        <h3 class="text-center mt-3">Other Blogs</h3>
                                        <ul class="nav canvas-tabs tabs nav-tabs size-sm mb-3" id="canvas-tab"
                                            role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active" id="canvas-tab-1" data-bs-toggle="pill"
                                                    data-bs-target="#tab-1" type="button" role="tab"
                                                    aria-controls="canvas-tab-1" aria-selected="true">Popular</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="canvas-tab-2" data-bs-toggle="pill"
                                                    data-bs-target="#tab-2" type="button" role="tab"
                                                    aria-controls="canvas-tab-2" aria-selected="false"
                                                    tabindex="-1">Recents</button>
                                            </li>
                                        </ul>
                                        <div id="canvas-TabContent" class="tab-content">
                                            ...
                                            <div class="tab-pane" id="tab-2" role="tabpanel"
                                                aria-labelledby="canvas-tab-2" tabindex="0">
